...
struct PieChartSlide: View {
    ...
    public var body: some View {
        path.fill(slideData.data.color)
            .overlay(path.stroke(Color(.systemBackground), lineWidth: 1))
...
struct PieChartSlide_Previews: PreviewProvider {
    static var previews: some View {
        GeometryReader { geometry in
            PieChartSlide(geometry: geometry, slideData: SlideData(startAngle: .degrees(-70), endAngle: .degrees(30)), index: 1)
        }
    }
}
